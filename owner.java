...
public class Owner extends User
{
   public String ownername;
    ...
    public Owner(int user_id, String user_type,String ownername,String password,String email,int phonenumber,Date birthdate, String payment_method,String imagePath,drone drone)
    {
        ...
        public  void owner_Sign_Up()
            {
               ...
               Owner newowner= new Owner(id,"Owner",nOname,nOpass ,nOemail,nOphone,birthdate,nOpay ,nOimg,newdrone);
